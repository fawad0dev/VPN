"""
OpenVPN protocol manager.
Wraps the existing OpenVPNManager logic and exposes the BaseVPNManager interface.
"""
import os
import shutil
import subprocess
...
class OpenVPNProtocol(BaseVPNManager):
    """Drives the openvpn.exe CLI subprocess."""
